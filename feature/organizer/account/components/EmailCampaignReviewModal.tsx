...
export type EmailCampaignReviewPayload = {
  event: {
    title: string;
    date: string;
    amountRange: string;
...
type EmailCampaignReviewModalProps = {
  visible: boolean;
  payload: EmailCampaignReviewPayload;
  onBack: () => void;
  onEdit: () => void;
  onSubmit: () => void;
  onDismiss: () => void;
...
EmailCampaignReviewModal.displayName = "EmailCampaignReviewModal";

export default EmailCampaignReviewModal;
